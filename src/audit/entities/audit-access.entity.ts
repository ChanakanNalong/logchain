...
export class AuditAccess {
  ...
  @Column({ type: 'varchar', length: 128, nullable: true }) username:
    | string
    | null;
  ...
  @Column({ name: 'status_code', type: 'int', nullable: true }) statusCode:
    | number
    | null;
  @Column({ name: 'ip_address', type: 'inet', nullable: true }) ipAddress:
    | string
    | null;
  @Column({ name: 'duration_ms', type: 'int', nullable: true }) durationMs:
    | number
    | null;
  @Index()
