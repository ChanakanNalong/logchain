...
> | C README | ✅ |
>
> **ทดสอบตาม "เกณฑ์ว่าเสร็จแล้ว" ท้ายเอกสารแล้ว — ผ่านเกือบครบ**
> ยกเว้น 2 ข้อ: login ผ่านเบราว์เซอร์จริง (ยังไม่ได้ลอง) และ cron seal → `CONFIRMED`
> (ไม่เกิด batch เลยถ้าไม่ตั้ง blockchain — ดู worklog หัวข้อ 8)
