...
- **B1 แก้แล้ว** (6.7 · 2026-09-25): เจ้าของรัน runbook ครบ + ทดสอบ reboot · `check-encryption-at-rest.sh` ผ่าน · PCI 3.1 PARTIAL → PASS (E12) · ISO R03 อัปเดต control · ลบ data-root เดิม + ปิด swap แล้ว
