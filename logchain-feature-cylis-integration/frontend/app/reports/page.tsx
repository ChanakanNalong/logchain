...
import { incidentTimeline, merkleProofSummary } from '@/lib/mockData';
          ...
          {incidentTimeline.map((item, i, arr) => (
            <div key={i} style={{ display: 'flex', gap: 12 }}>
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <div style={{ width: 9, height: 9, borderRadius: 999, background: t[item.tone as keyof Theme] || t.blue, marginTop: 4 }} />
