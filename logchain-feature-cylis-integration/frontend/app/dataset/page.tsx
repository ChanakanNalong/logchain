...
import { monoFont, sansFont } from '@/lib/theme';
import { Card, SectionLabel, Badge } from '@/components/ui';
import { datasetStats, rawHdfsLogs, dataSources } from '@/lib/mockData';

export default function DatasetPage() {
  const t = useTheme();
  const levelColor: Record<string, string> = { INFO: t.good, WARN: t.warn, ERROR: t.danger };
