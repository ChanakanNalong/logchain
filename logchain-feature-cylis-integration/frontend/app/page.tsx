...
import { monoFont, sansFont, type Theme } from '@/lib/theme';
import { Card, SectionLabel, Badge } from '@/components/ui';
import LogTable from '@/components/LogTable';
import { kpiCards, trafficByHour, topAttackSources, recentLogs } from '@/lib/mockData';
import PillBar from './_components/PillBar';
        ...
        {kpiCards.map((k) => (
          <Card key={k.label}>
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              <SectionLabel dot={t[k.tone as keyof Theme] || t.blue}>{k.label}</SectionLabel>
          ...
          <div style={{ height: 230, marginTop: 18 }}>
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={trafficByHour} barCategoryGap="32%">
                ...
                <Bar
                  dataKey="total"
                  shape={(props: BarProps & { payload?: { isSpike?: boolean } }) => (
