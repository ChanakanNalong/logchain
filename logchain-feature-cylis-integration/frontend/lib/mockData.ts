import { ScrollText, TriangleAlert, ShieldCheck, Activity, type LucideIcon } from 'lucide-react';
import type { BadgeTone } from '@/components/ui';
import type { LogRow } from '@/components/LogTable';

export const kpiCards: { label: string; value: string; delta: string; tone: BadgeTone; icon: LucideIcon }[] = [
...
export const topAttackSources: { ip: string; country: string; hits: number; risk: BadgeTone }[] = [
...
export const recentLogs: LogRow[] = [
...
export const hdfsSequences: { id: string; seq: string[]; label: 'normal' | 'anomaly'; score: number }[] = [
...
export const rawHdfsLogs: { ts: string; level: 'INFO' | 'WARN' | 'ERROR'; event: string; block: string; text: string }[] = [
...
export const incidentTimeline: { t: string; e: string; tone: BadgeTone }[] = [
